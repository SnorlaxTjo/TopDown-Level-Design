...
public class Player : Entity
{
    ...
    [Header("Healing")]
    [SerializeField] float timeToWaitBeforeStartingHealing;
    [SerializeField] float timerBeforeEachHpHeal;
    ...
    private float timeLeftUntilNextHeal;
    ...
    private void AutomaticHeal()
    {
        ...
        {
            timeLeftUntilNextHeal -= Time.deltaTime;
        }
    }

    public void ResetAutomaticHeal()
    {
        timeLeftUntilNextHeal = timeToWaitBeforeStartingHealing;
    }
